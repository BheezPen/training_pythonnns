...
bu1.grid=0,column=0,sticky='snew',ipadx=40,ipady=40
bu1.config(cd(rowommand=lambda: ButtonClick(1))
row=0,column=1,sticky='snew',ipadx=40,ipady=40)
bu2.config(c
bu2=ttk.Button(root,text=' ')
bu2.grid(ommand=lambda: ButtonClick(2))
